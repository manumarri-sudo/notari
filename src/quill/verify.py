...
class ScanLimits:
    ...
    def from_env(cls, env: dict[str, str]) -> ScanLimits:
        ...
        return cls(
            max_diff_bytes=_pos_int("QUILL_MAX_DIFF_BYTES", DEFAULT_MAX_DIFF_BYTES),
            max_files=_pos_int("QUILL_MAX_FILES", DEFAULT_MAX_FILES),
            git_timeout=_pos_int("QUILL_GIT_TIMEOUT", DEFAULT_GIT_TIMEOUT),
        )
    ...
    *,
    ...
    if strict and not contract.repo:
        ...
        repo_msg = (
            ...
            "unknown; strict requires --repo on the contract and QUILL_REPO_ID / "
    ...
    try:
        ...
        for i in range(0, len(parts) - 1, 2):
            ...
            if not path or path.startswith(".quill/"):
                continue
